...
_lr_productions = [
  ...
  ('Ply -> Lex Yacc Codigo','Ply',3,'p_Ply','ply-simple.py',131),
  ('Lex -> LEX Listas Expregulares','Lex',3,'p_Lex','ply-simple.py',136),
  ('Listas -> Listas Lista','Listas',2,'p_Listas_list','ply-simple.py',140),
  ('Listas -> <empty>','Listas',0,'p_Listas_empty','ply-simple.py',144),
  ('Lista -> TOKENS = STRING','Lista',3,'p_Lista_tokens','ply-simple.py',148),
  ('Lista -> LITERALS = STRING','Lista',3,'p_Lista_literals','ply-simple.py',152),
  ('Lista -> IGNORE = STRING','Lista',3,'p_Lista_ignore','ply-simple.py',157),
  ('Lista -> PRECEDENT = STRING','Lista',3,'p_Lista_precedent','ply-simple.py',161),
  ('Lista -> DIC = STRING CLOSEDIC','Lista',4,'p_Lista_ts','ply-simple.py',165),
  ('Lista -> DIC = CLOSEDIC','Lista',3,'p_Lista_tsempty','ply-simple.py',169),
  ('Expregulares -> Expregulares Expregular','Expregulares',2,'p_Expregulares_list','ply-simple.py',174),
  ('Expregulares -> <empty>','Expregulares',0,'p_Expregulares_empty','ply-simple.py',178),
  ('Expregular -> EXPREG CODE','Expregular',2,'p_Expregular_exp','ply-simple.py',182),
  ('Yacc -> YACC Listas Producoes','Yacc',3,'p_Yacc_list','ply-simple.py',205),
  ('Producoes -> Producoes Producao','Producoes',2,'p_Producoes_notempty','ply-simple.py',209),
  ('Producoes -> <empty>','Producoes',0,'p_Producoes_empty','ply-simple.py',213),
  ('Producao -> PRODUCAO CODE','Producao',2,'p_Producao','ply-simple.py',217),
  ('Codigo -> STARTOFCODE ListaComandos ENDCODE','Codigo',3,'p_Codigo_notempty','ply-simple.py',224),
  ('Codigo -> <empty>','Codigo',0,'p_Codigo_empty','ply-simple.py',228),
  ('ListaComandos -> ListaComandos CODE','ListaComandos',2,'p_ListaComandos_code','ply-simple.py',232),
  ('ListaComandos -> ListaComandos INDEPENDENTCODE','ListaComandos',2,'p_ListaComandos_independentcode','ply-simple.py',236),
  ('ListaComandos -> <empty>','ListaComandos',0,'p_ListaComandos_empty','ply-simple.py',240),
]
